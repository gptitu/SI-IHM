	...
	class JeuDao{
		...
		public function findJeu(){
			...
			while($_jeu = $this->result->fetch()){
				$game[] = new Jeu($_jeu->id, $_jeu->nom, $_jeu->categorie, $_jeu->constructeur, $_jeu->dateSortie, $_jeu->prix);
			} return $game;
		}
		...
		public function insertJeu($_jeu){
			...
			if($_jeu instanceof Jeu){
				...
				if(!$this->exists($_jeu)){
					...
					$n = $this->bdd->exec("INSERT INTO Jeu VALUES('".$_jeu->getId()."', '".$_jeu->getNom()."', '".$_jeu->getCategorie()."', '".$_jeu->getConstructeur()."', '".$_jeu->getDateSortie()."', '".$_jeu->getPrix()."')");
					return $n;
		...
		public function updateJeu($_jeu){
			...
			if($_jeu instanceof Jeu){
				...
				$settings = "SET id='".$_jeu->getId()."', nom='".$_jeu->getNom()."', categorie='".$_jeu->getCategorie()."', constructeur='".$_jeu->getConstructeur()."', dateSortie='".$_jeu->getDateSortie()."', prix='".$_jeu->getPrix()."'";
